...
namespace restapi.Models
{
    public class Timecard
    {
        ...
        public int searchLine(string lineId)
        {
        ...
        public AnnotatedTimecardLine replace(int index, TimecardLine t)
        {

            Lines[index].Week = t.Week;
            Lines[index].Year = t.Year;
            Lines[index].Day = t.Day;
            Lines[index].Hours = t.Hours;
            Lines[index].Project = t.Project;

            var annotaedLine = Lines[index];
            return annotaedLine; 
        }

        public AnnotatedTimecardLine update(int index, TimecardLine t)
        {

            if(t.Week >0) { Lines[index].Week = t.Week; }
            if(t.Year >0) { Lines[index].Year = t.Year; }
            if (t.Day >=0 ) { Lines[index].Day = t.Day; }
            if (t.Hours >0) { Lines[index].Hours = t.Hours; }
            if (t.Project != null) { Lines[index].Project = t.Project; }
